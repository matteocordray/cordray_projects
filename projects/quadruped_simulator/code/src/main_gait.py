...
sarge5_Id = p.loadURDF("../URDF/05-sarge5_v1_stuck.urdf",cubeStartPos, cubeStartOrientation)
maxForce = 50
...
time_c = int(p.addUserDebugParameter("time", 5, 100, 50))
...
def printPositions():
    print("FLxe: " + str(FLxe) + " FRxe: " + str(FRxe))
    print("FLye: " + str(FLye) + " FRye: " + str(FRye))
    print("FLze: " + str(FLze) + " FRze: " + str(FRze))
